...
- Решение ежедневной задачи инженера нагрузочного тестирования: быстрый и удобный разбор прогонов.
...
- Сравнение прогонов old vs new.
- БД + история прогонов (volume в Docker).
